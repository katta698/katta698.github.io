...
<main class="page">
 ...
 <details class="about">
  ...
  <p><strong>The catalog is not finished yet.</strong> AWS's own catalog
   ...
   sessions to keep arriving right up to the event. That is what the
   scheduled refresh is for, and why a plan built today is a first
   draft.</p>
  ...
  <p><strong>How current this is, and how you can tell.</strong> The catalog
   is re-fetched from AWS <strong>every three hours</strong> by a scheduled
   job, and <strong>every hour</strong> from the fortnight before the event
   through to the last day &mdash; the cadence follows how fast the catalog
   actually moves, and on 23 September it moved twice in a day. The line at
   the
